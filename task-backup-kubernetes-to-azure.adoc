...
--
Régions Azure prises en charge:: La sauvegarde et la restauration BlueXP sont prises en charge dans toutes les régions Azure https://["Dans ce cas, Cloud Volumes ONTAP est pris en charge"^].
