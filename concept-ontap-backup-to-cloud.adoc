...
* Possibilité d'effectuer une _restauration rapide_ d'un volume depuis le stockage cloud vers un système Cloud Volumes ONTAP ou sur un système sur site ; idéal pour les situations de reprise d'activité où vous devez fournir un accès à un volume dès que possible.
