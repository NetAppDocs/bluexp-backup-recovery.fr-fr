...
** Installez le plug-in à l'aide du script et ajoutez l'hôte à partir de l'interface utilisateur à l'aide de l'option manuelle. <<Ajoutez l'hôte à partir de l'interface utilisateur à l'aide de l'option manuelle et installez le plug-in à l'aide du script,En savoir plus >>>>.


* Si SSH est désactivé, installez le plug-in manuellement et ajoutez l'hôte à partir de l'interface utilisateur à l'aide de l'option Manual. <<Ajoutez l'hôte à partir de l'interface utilisateur à l'aide de l'option manuelle et installez le plug-in manuellement,En savoir plus >>>>.
