...
Le catalogue indexé v2, publié en février 2025, a de nouvelles fonctionnalités qui le rendent plus efficace et plus facile à utiliser. Cette version offre une amélioration significative des performances et est activée par défaut pour tous les nouveaux clients.
