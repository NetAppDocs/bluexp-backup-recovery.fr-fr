...
----
+
Bien que l'adresse IP, le nom d'utilisateur et les mots de passe soient des valeurs personnalisées, le nom du compte ne l'est pas. Le nom du compte est toujours "Account-DARKSITE1".
