...
+
Vous pouvez également activer ou désactiver les analyses par ransomware planifiées.
...
Reportez-vous à la section link:manage-backup-settings-ontap.html["Comment mettre à jour les options de protection contre les ransomware dans la page Paramètres avancés"].
