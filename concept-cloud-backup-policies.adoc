...
* Vos clusters doivent exécuter ONTAP 9.11.1 ou version ultérieure (9.12.1 dans le cas d'Azure)
...
* L'option DataLock que vous sélectionnez lors de l'activation de Cloud Backup doit être utilisée pour toutes les stratégies de sauvegarde pour ce cluster.
