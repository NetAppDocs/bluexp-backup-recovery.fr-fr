...
| Déploiement cloud | Suivez les instructions de la section https://["Connexion à la machine virtuelle Connector Linux"^] en fonction du fournisseur cloud que vous utilisez. 
