...
La documentation de chaque API de sauvegarde et de restauration BlueXP  est disponible sur https://docs.netapp.com/us-en/bluexp-automation/cbs/overview.html["Automatisation BlueXP "^].
