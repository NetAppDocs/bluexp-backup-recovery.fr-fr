...
* AWS : https://aws.amazon.com/marketplace/pp/prodview-oorxakq6lq7m4["Consultez l'offre Marketplace pour les services intelligents NetApp pour connaître les tarifs"^].
...
* Azure: https://azuremarketplace.microsoft.com/en-us/marketplace/apps/netapp.cloud-manager?tab=Overview["Consultez l'offre Marketplace pour les services intelligents NetApp pour connaître les tarifs"^].
...
* Google Cloud : https://console.cloud.google.com/marketplace/details/netapp-cloudmanager/cloud-manager?supportedpurview=project["Consultez l'offre Marketplace pour les services intelligents NetApp pour connaître les tarifs"^].
