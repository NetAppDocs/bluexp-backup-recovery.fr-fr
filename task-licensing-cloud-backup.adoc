...
https://["En savoir plus sur ces packs de licence basés sur la capacité"].
...
* AWS : https://["Consultez l'offre BlueXP Marketplace pour obtenir des informations sur les tarifs"^].
...
* Azure : https://["Consultez l'offre BlueXP Marketplace pour obtenir des informations sur les tarifs"^].
...
* GCP : https://["Consultez l'offre BlueXP Marketplace pour obtenir des informations sur les tarifs"^].
...
Lors de l'utilisation d'AWS, deux contrats annuels sont disponibles auprès du https://["Page AWS Marketplace"^] Pour les systèmes Cloud Volumes ONTAP et ONTAP sur site. Disponibles en 1, 2 ou 3 ans :
...
Si vous ne souhaitez pas utiliser de licence basée sur des nœuds non attribuée à Cloud Volumes ONTAP, vous pouvez la convertir en licence de sauvegarde et de restauration BlueXP avec la même équivalence en dollar et la même date d'expiration. https://["Cliquez ici pour plus d'informations"^].
...
Si la durée de votre licence approche de la date d'expiration ou si votre capacité sous licence atteint la limite, vous serez informé dans l'interface utilisateur de la sauvegarde. Cet état apparaît également sur la page du portefeuille digital BlueXP et dans https://["Notifications"].
