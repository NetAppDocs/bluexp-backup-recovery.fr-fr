...
Vous pouvez télécharger le contenu de la page principale de surveillance des travaux sous forme de rapport après l'avoir affiné. Cloud Backup génère et télécharge un fichier .CSV que vous pouvez consulter et envoyer à d'autres groupes si nécessaire. Le fichier .CSV contient jusqu'à 10,000 lignes de données.
...
Pour recevoir les alertes par e-mail de Cloud Backup, vous devez sélectionner les types de sévérité des notifications « critique » et « erreur ».
