...
. Pour afficher des colonnes supplémentaires (Environnement de travail, SVM, Nom d'utilisateur, charges de travail, politique, Et Snapshot Label), sélectionnez image:button_plus_sign_round.png["le bouton signe plus"].
...
Le Centre de notification affiche de nombreux événements, mais seuls les événements de sauvegarde et de restauration suivants déclenchent des alertes par e-mail :
