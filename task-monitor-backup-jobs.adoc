...
Le Centre de notification affiche de nombreux événements Snapshot, de réplication, de sauvegarde dans le cloud et de restauration, mais seuls les événements suivants déclenchent des alertes par e-mail :

[cols="1,2,1,1"]
|===
| Type d'opération | Fonctionnement | Niveau d'alerte | E-mail envoyé 
