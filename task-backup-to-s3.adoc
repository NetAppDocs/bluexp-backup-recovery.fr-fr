...
[NOTE]
====
Si vous créez des sauvegardes dans des régions AWS GovCloud ou AWS China, vous devez modifier le nom de ressource AWS « arn » sous toutes les sections _Resource_ dans les jeux d'autorisations ci-dessus et ci-dessous :
