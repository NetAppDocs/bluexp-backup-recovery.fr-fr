...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["Trois"] Préparez la mise en réseau pour le connecteur
[role="quick-margin-para"]
Assurez-vous que le connecteur dispose des connexions réseau requises.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Quatre"] Vérifiez les exigences de licence
[role="quick-margin-para"]
Vous devez vérifier les exigences de licence pour Google Cloud et BlueXP.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Cinq"] Préparez vos clusters ONTAP
[role="quick-margin-para"]
