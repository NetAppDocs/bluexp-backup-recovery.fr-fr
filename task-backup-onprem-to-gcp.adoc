...
* Vous avez découvert le cluster sur site et l'avez ajouté comme environnement de travail dans BlueXP. Voir https://docs.netapp.com/us-en/bluexp-ontap-onprem/task-discovering-ontap.html["Découverte des clusters ONTAP"^] pour plus d'informations.
+
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-google.html["Installation d'un connecteur dans GCP"^]
