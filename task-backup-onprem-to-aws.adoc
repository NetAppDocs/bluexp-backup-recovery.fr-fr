...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-aws.html["Installation d'un connecteur dans AWS"^]
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-install-restricted-mode.html["Installation d'un connecteur dans une région AWS GovCloud"^]
+
