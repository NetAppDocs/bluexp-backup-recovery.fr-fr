...
* link:task-manage-backup-settings-ontap.html["Gérer les paramètres de sauvegarde"]
* link:task-create-policies-ontap.html["Gérez les règles des volumes ONTAP"]
* link:concept-cloud-backup-policies.html["Paramètres de la règle de sauvegarde sur objet"]
