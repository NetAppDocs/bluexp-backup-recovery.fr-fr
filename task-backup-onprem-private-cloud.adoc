...
StorageGRID doit remplir les conditions suivantes. Voir la https://["Documentation StorageGRID"^] pour en savoir plus.
...
--
Identifiants S3:: Vous devez avoir créé un compte de locataire S3 pour contrôler l'accès à votre stockage StorageGRID. https://["Pour plus d'informations, consultez la documentation StorageGRID"^].
+
--
...
* Votre StorageGRID doit être https://["Découvert et disponible dans BlueXP Canvas"^].
