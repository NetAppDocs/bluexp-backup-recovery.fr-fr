...
Pour plus d'informations sur les exigences de verrouillage de données et de protection contre les ransomware pour StorageGRID, reportez-vous à link:concept-cloud-backup-policies.html["Options de règle de sauvegarde sur objet"].
