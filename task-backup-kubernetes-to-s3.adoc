...
--
Régions AWS prises en charge:: La sauvegarde et la restauration BlueXP sont prises en charge dans toutes les régions AWS https://["Dans ce cas, Cloud Volumes ONTAP est pris en charge"^].
Autorisations AWS Backup requises:: Le rôle IAM qui fournit à BlueXP des autorisations doit inclure des autorisations S3 à partir des dernières https://["Politique BlueXP"^].
+
--
