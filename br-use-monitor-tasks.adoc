...
La BlueXP backup and recovery conservent les informations de travail pendant 15 jours, après quoi elles sont purgées et ne sont plus visibles dans le moniteur de travail.
