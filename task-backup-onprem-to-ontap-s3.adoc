...
TIP: Pour créer une règle personnalisée à l'aide de l'interface utilisateur, reportez-vous à la section link:task-create-policies-ontap.html["Création d'une règle"].
